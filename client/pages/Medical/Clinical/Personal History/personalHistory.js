...
Meteor.subscribe('PatientInfo');
  ...
  Template.personalHistory.helpers({
 ...
 History: function() {
  ...
  isChecked2: function (type) {
      return (this && this.MaritalHistory === type) ? 'checked' : null;
        },
  SpecialHabits: function (type) {
       return (this && this.SpecialHabits === type) ? 'checked' : null;
        },
   Allergy: function (type) {
        return (this && this.Allergy.Allergy === type) ? 'checked' : null;
        },
    DrugsReaction: function (type) {
        return (this && this.DrugsReaction.DrugsReaction === type) ? 'checked' : null;
        },
    General: function (type) {
        return (this && this.General.General === type) ? 'checked' : null;
        },
    Pain: function (type) {
        return (this && this.Pain.Pain === type) ? 'checked' : null;
        },
    RespiratorySystem: function (type) {
        return (this && this.RespiratorySystem.RespiratorySystem === type) ? 'checked' : null;
        },
    GardiovascularSystem: function (type) {
            return (this && this.GardiovascularSystem.GardiovascularSystem === type) ? 'checked' : null;
            },
    GastrointestinalSystem: function (type) {
            return (this && this.GastrointestinalSystem.GastrointestinalSystem === type) ? 'checked' : null;
            },
    GenitourinarySystem: function (type) {
            return (this && this.GenitourinarySystem.GenitourinarySystem === type) ? 'checked' : null;
            },
    EndocrineSystem: function (type) {
            return (this && this.EndocrineSystem.EndocrineSystem === type) ? 'checked' : null;
            },
    NeurologicalSystem: function (type) {
            return (this && this.NeurologicalSystem.NeurologicalSystem === type) ? 'checked' : null;
            },
...
Template.personalHistory.events({
...
//History by Ststems
      ...
      NeurologicalSystemReadable.EndocrineSystem= $(NeurologicalSystem).val();
